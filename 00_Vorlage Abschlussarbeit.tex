...
\include{entwicklung_erwartungshaltung}

\include{literaturueberblick}

\include{implementationsdetails}
...
einleitung, interviews, grundlagen, literaturüberblick,

schauen wie andere technicken benutzen und daraus baue ich mein system

überlegen ob man information aus 2.1 und 2.2 mit in die einleitung. Inhalt mit in einleitung einbringen. das ergebnis der erwartungshaltung ist. Experteninterview ist rechtfertigung für alles andere.

aus interviews use cases herausziehen. Das soll die software können und das soll der prozess sein den die software abbildet (technologien) 
