...
\begin{longtable}{| p{0.5cm} | p{0.5cm} | p{4cm} | p{4cm} | p{4cm} |}
	...
	\cline{1-4}
	1 & 10 & Gute Abstimmungen bevor die Bedarfsmeldung erstellt wird, ggf. durch ein Quality-Gate (Review). & \st{Abstimmung vor Bedarfsmeldungserstellung durch Quality-Gate (Review)} & \multirow{3}{4cm}{K5 Qualitätsbewertung \\ -keine vorhanden \\ -Erfahrung \\ -über Projektleitung \\ -intensives Lesen \\ -Rückfragen stellen \\ -grober Rahmen durch Jira \\ -regelmäßige Meetings \\ \
