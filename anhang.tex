...
\newpage
\section{Paraphrasierung, Generalisierung und Reduktion}
\label{sec:reduktion}
%\begin{center}
\begin{longtable}{| p{0.5cm} | p{0.5cm} | p{4cm} | p{4cm} | p{4cm} |}
	...
	\cline{1-4}
	1 & 4 & Bedarfsmeldungen sollten aussagefähig sein, welche technischen Kompetenzen wichtig sind, welche Tagessätze, ob Remote möglich ist und die Dauer. & \st{Aussagefähigkeit von Bedarfsmeldungen durch technischen Kompetenzen, Tagessätze, Remote Möglichkeit und Dauer} & \multirow{3}{4cm}{K3 Wichtige Informationen \\ -Tagessatz \\ -Einsatz \\ -Dauer \\ -Tech Stack \\ -Muss/Kann Kriterien \\ -Einarbeitungs-zeiträume \\ -Lieferverpflichtung \\ \
	...
	\cline{1-4}
	1 & 9 & Auswirkungen fehlender Informationen sind, dass das Staffing länger dauert und die Stellen potenziell durch andere Dienstleister besetzt werden. & Fehlinformations-auswirkungen sind längerer Staffingprozess und Umbesetzung durch anderen Dienstleister & \multirow{3}{4cm}{K5 Qualitätsbewertung \\ -keine vorhanden \\ -Erfahrung \\ -über Projektleitung \\ -intensives Lesen \\ -Rückfragen stellen \\ -grober Rahmen durch Jira \\ -regelmäßige Meetings \\ \
	...
	\cline{1-4} 
	2 & 13 & Die Dokumentation der Bedarfsmeldungen variiert je nach Kundenanforderungen, von einfachen Word-Dokumenten bis zu detaillierten Präsentationen. & Dokumentation von Bedarfsmeldung variieren (von Word-Dokument bis Präsentation) & \multirow{3}{4cm}{K7 Auswirkungen \\ -Überblick verlieren \\ -längerer Staffing-Prozess \\ -Umbesetzung \\ -erhöhter Aufwand \\ -Mehrfachbeantwortung \\ -Missverständnis \\ -unpassendes Personal \\} \\ 
	\cline{1-4}
	...
	\cline{1-4}
	2 & 18 & Unklare Informationen in Bedarfsmeldungen erhöhen den Aufwand und führen zu Nacharbeit und potenziellen Konflikten zwischen den Beteiligten. & \st{Unklare Informationen erhöhen Aufwand und resultieren in Nacharbeiten und Konflikten} & \\ 
	\cline{1-4}
	...
	\cline{1-4}
	3 & 20 & Bedarfsmeldungen können entweder vom Kunden direkt kommen oder von uns selbst formuliert werden. & \st{Bedarfsmeldungen können selbst formuliert oder vom Kunden stammen}  & \\ 
	\cline{1-4}
	3 & 21 & Bedarfsmeldungen enthalten wirtschaftlich relevante Informationen wie vertragliche Konditionen, Tagessatz, Einsatzbeginn und voraussichtlicher Einsatzzeitraum. & \st{Bedarfsmeldungsinfomationen sind vertragliche Konditionen, Tagessatz, Einsatzbeginn und Einsatzzeitraum} & \\ 
	\cline{1-4}
	...
	\cline{1-4}
	3 & 23 & Unklare oder unvollständige Bedarfsmeldungen können zu Missverständnissen führen und den Staffing-Prozess verlangsamen. & \st{Unvollständige Bedarfsmeldungen führen zu Missverständnissen und langsamen Staffing-Prozess} & \\ 
	\cline{1-4}
	3 & 24 & Projekte können entweder vom Kunden gesteuert werden oder von uns im Kundenauftrag durchgeführt werden. & \st{Bedarfe sind entweder Kundengesteuert oder Kundenaufträge} & \\ 
	\cline{1-4}
	...
	\cline{1-4}
	3 & 28 & Versierte Personen wie Delivery Manager oder Account Manager sollten den Prozess der Anforderungserhebung und Dokumentation begleiten und moderieren, um sicherzustellen, dass alle relevanten Informationen erfasst werden. & Begleitung der Bedarfsmeldungsdokumentierung durch Delivery Manager oder Account Manager & \\ 
	\cline{1-4}
	4 & 29 & Die Erstellung von Bedarfsmeldungen erfolgt durch Projektleiter und interne Maitre. Diese stimmen den Bedarf ab und sind für das Staffing verantwortlich. & \st{Staffingverantwortliche sind Projektleiter und Maitre} & \\ 
	\cline{1-4}
	4 & 30 & Rahmenbedingungen wie Kunde, Einsatzbeginn, Laufzeit, Ort und Tagessatz sowie notwendige Skills und Aufgabenbeschreibungen sind unverzichtbar in Bedarfsmeldungen. & \st{Unverzichtbare Bedarfsmeldungsinformationen sind Rahmenbedingungen, Einsatzbeginn, Laufzeit, Ort und Tagessatz, Skills und Aufgabenbeschreibungen} & \\ 
	\cline{1-4}
	4 & 31 & Bedarfsmeldungen werden über Jira erfasst und mit allen beteiligten Parteien geteilt. & \st{Bedarfsmeldungserfassung in Jira} & \\ 
	\cline{1-4}
...
\label{synthetischedaten}
\subsection{Durchlauf zwei}
\paragraph{Ausgangslage}\mbox{}\\
Für verschiedene IT-Projekte (mit internen und externen Kunden) benötigen wir eine temporäre Unterstützung von einem Projektleiter, mit den nachfolgenden, groben Anforderungen:\textbackslash r\textbackslash n• Erfahrungen in der Planung, Koordination und Durchführung von IT-Migrations- und Implementierungsprojekten im Umfeld von Rechenzentrumsservices (Hosting, Client Services, Netzwerk).\textbackslash r\textbackslash n• Nachhalten und Tracken der Projekte an der Schnittstelle von internen und externen Kunden sowie den technischen Fachbereichen für die Rechenzentrumsservices.\textbackslash r\textbackslash n• Zumindest ein Grundverständnis für Rechenzentrumsservices, um sich fachlich in diesem Themenkreis bewegen zu können.\textbackslash r\textbackslash n\textbackslash r\textbackslash nAus meiner Sicht benötigen wir keinen Projektleiter mit 10 oder mehr Jahren Berufserfahrung, es kann auch ein jüngerer Projektleiter sein. Notwendig ist aber jemand, der ein Verständnis für die technischen Themen besitzt und sich in diesem Umfeld bewegen kann und jemand, der an offenen Punkten dran bleibt und diese vorantreibt.
\paragraph{Erwartungshaltung}\mbox{}\\
\begin{itemize}
	\itemsep-0.5em
	\item verschiedene IT-Projekte 
	\item internen und externen Kunden 
	\item temporäre Unterstützung
	\item Projektleiter
	\item Erfahrungen in Planung, Koordination und Durchführung von IT-Migrations- und Implementierungsprojekten
	\item Umfeld von Rechenzentrumsservices 
	\item Hosting, Client Services, Netzwerk
	\item Nachhalten und Tracken der Projekte an der Schnittstelle von internen und externen Kunden sowie den technischen Fachbereichen für die Rechenzentrumsservices
	\item Grundverständnis für Rechenzentrumsservices
	\item keinen Projektleiter mit 10 oder mehr Jahren Berufserfahrung
	\item jüngerer Projektleiter sein
	\item Verständnis für die technischen Themen 
	\item an offenen Punkten dran bleibt und vorantreibt.
\end{itemize}
\subsection{Durchlauf drei}
\paragraph{Ausgangslage}\mbox{}\\
Softwareentwickler C++ im Kontext Tactical Supply Chain Optimization.\textbackslash r \textbackslash nNutzung, Einrichten und Supporten von modernen Infrastrukturen (Kubernetes,\textbackslash r\textbackslash nGCP, ...)\textbackslash r\textbackslash nEntwicklung und Umsetzung von teaminternen Konzepten (z.B. Konzepte zur\textbackslash r\textbackslash nDatenhaltung und Optimierung von SQL-Abfragen, Umsetzung von Algorithmen).\textbackslash r\textbackslash nErweiterung, Verbesserung und Erstellung von Gitlab-Pipelines für eine höheren\textbackslash r\textbackslash nAutomatisierungsgrad\textbackslash r\textbackslash nUmsetzung von eventgetriebenen Architekturen in z.B. Kafka\textbackslash r\textbackslash nUmsetzung von Konzepten, wie Test-Driven (Testgetriebene Entwicklung) und\textbackslash r\textbackslash nautomatisierte Tests\textbackslash r\textbackslash nLinux Skripte erstellen\textbackslash r\textbackslash nKollaboratives Arbeiten im Team (z.B. mit Git/Gitlab)
\paragraph{Erwartungshaltung}\mbox{}\\
\begin{itemize}
	\itemsep-0.5em
	\item Softwareentwickler C++ 
	\item Tactical Supply Chain Optimization
	\item Nutzung, Einrichten und Supporten modernen Infrastrukturen
	\item Kubernetes, GCP, 
	\item Entwicklung und Umsetzung teaminternen Konzepten
	\item Konzepte Datenhaltung und Optimierung von SQL-Abfragen
	\item Umsetzung Algorithmen
	\item Erweiterung, Verbesserung und Erstellung von Gitlab-Pipelines
	\item höheren Automatisierungsgrad
	\item Umsetzung eventgetriebenen Architekturen Kafka
	\item Umsetzung Konzepten, wie Test-Driven
	\item nautomatisierte Tests
	\item Linux Skripte erstellen
	\item Kollaboratives Arbeiten im Team
	\item Git/Gitlab
\end{itemize}
